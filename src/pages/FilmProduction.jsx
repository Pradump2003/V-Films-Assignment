          ...
          <div className="flex flex-col justify-between h-full mt-6 md:mt-0">
            <div>
              <p className="text-sm sm:text-base leading-relaxed">
                ...
                We see them as a way to live many lives - to <br />
                feel, to explore, and to tell stories that stay. <br /> And with
                each film, we carry new memories <br /> and new reasons to keep
                creating. <br />V crafts:
              </p>
